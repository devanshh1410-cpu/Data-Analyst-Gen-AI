...
/* Constraints are used to specify rules for data in a table.
 It ensures the accuracy and reliability in the dataset.
 Mostly commonly used constraints are :
1-NOT NULL: Prevents a column from having empty (NULL) values.
2-UNIQUE: Ensures all values in a column are distinct.
3-PRIMARY KEY: A combination of NOT NULL and UNIQUE.
4-FOREIGN KEY: Links a record to a primary key in another table.
5-CHECK: Ensures values meet a specific logical condition.
6-DEFAULT: Sets a "fallback" value if no 
